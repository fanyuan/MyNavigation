...
public class ReuseFragmentNavigator extends FragmentNavigator {
    private static final String TAG = "ReuseFragmentNavigator";
    private Context mContext;
    private FragmentManager mFragmentManager;
    private int mContainerId;
    public ReuseFragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager, int containerId) {
